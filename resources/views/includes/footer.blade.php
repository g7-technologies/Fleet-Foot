                ...
                <footer class="footer text-center text-sm-left">
                    &copy; 2021 Fleet Foot <span class="text-muted d-none d-sm-inline-block float-right">Crafted with <i class="mdi mdi-heart text-danger"></i> by codembeded.com</span>
                </footer><!--end footer-->
            </div>
            <!-- end page content -->
        </div>
