        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="form-horizontal" class="form-horizontal form-wizard-wrapper" method="post" action="{{url('/add_order')}}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-control" name="sender" id="sender" onChange="get_sender_info()" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_email" name="sender_email" type="email" class="form-control" required disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-2">
                                            <input id="sender_phone_code" name="sender_phone_code" type="text" class="form-control" required disabled>
                                        </div>
                                        <div class="col-lg-7">
                                            <input id="sender_phone_number" name="sender_phone_number" type="text" class="form-control" required disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_residential_type" name="sender_residential_type" type="text" class="form-control" required disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_office_appartment" name="sender_office_appartment" type="text" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_building_villa" name="sender_building_villa" type="text" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_street" name="sender_street" type="text" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_address" name="sender_address" type="text" class="form-control" required disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_region" name="sender_region" type="text" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_city" name="sender_city" type="text" class="form-control" required disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_country" name="sender_country" type="text" class="form-control" required disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input id="sender_nearest_land_mark" name="sender_nearest_land_mark" type="text" class="form-control" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="delivery_boy_id" class="col-lg-3 col-form-label">Delivery Boy <span style="color:red">*</span></label>
                                        <div class="col-lg-9">
                                            <select id="delivery_boy_id" name="delivery_boy_id" class="form-control" required>
                                                <option value="">Please Select Delivery Boy</option>
                                                @foreach($delivery_boy as $delivery_boy_data)
                                                <option value="{{$delivery_boy_data->id}}">{{$delivery_boy_data->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row ml-4">
                                <div class="col-md-6 ml-4">
                                    <div class="form-group row">
                                        <div class="col-lg-9">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="is_fragile" name="is_fragile">
