        ...
        <div class="col-11">
            <div class="card">
                <div class="card-body order-list">
                    ...
                    <h4 class="header-title mt-0 mb-3">Unassigned Orders</h4>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                @foreach($delivery_boy as $delivery_boy)
                                                <a class="dropdown-item" href="{{url('/assigned_delivery_boy/'.$data->id.'/'.$delivery_boy->id)}}">{{$delivery_boy->name}}</a>
                                                @endforeach
                                            </div>
                                        </div>
                                    </td>
